...
<div id="ewd-us-dashboard-top-upgrade">
	<div id="ewd-us-dashboard-top-upgrade-left">
		<div id="ewd-dashboard-pro" class="postbox upcp-pro upcp-postbox-collapsible" >
			<div class="handlediv" title="Click to toggle"></div><h3 class='hndle ewd-dashboard-h3'><span><?php _e("UPGRADE TO FULL VERSION", 'ultimate-slider') ?></span></h3>
			<div class="inside">
				<h3><?php _e("What you get by upgrading:", 'ultimate-slider') ?></h3>
				<div class="clear"></div>
				<ul>
				...
				<div class="full-version-form-div">
					<form action="edit.php?post_type=ultimate_slider" method="post">
						<div class="form-field form-required">
							<!-- <label for="Catalogue_Name"><?php _e("Product Key", 'ultimate-slider') ?></label> -->
							<input name="Key" type="text" value="" size="40" placeholder="<?php _e('Enter product key or free trial code here', 'ultimate-slider'); ?>" />
						</div>
						<input type="submit" name="EWD_US_Upgrade_To_Full" value="<?php _e('UPGRADE', 'ultimate-slider'); ?>">
					</form>
				</div>
			</div>
		</div>
				...
				<div class="inside">
					<div class="topPart">
						...
						if(!get_option("EWD_US_Trial_Happening")){
							_e("Want to try out the premium features first?", 'ultimate-slider');
						}
						else{
							_e("Your free trial is currently active", 'ultimate-slider');
						}
						?>
					</div>
					<div class="clear"></div>
