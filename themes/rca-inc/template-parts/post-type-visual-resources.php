...
<div id="all-expertise-content">
		...
		<div class="small-10 small-offset-1 columns" >
			<div class="row">
				<div class="medium-3 columns">
					<a href="<?php echo $ssLink; ?>" target="_blank"><img src="<?php the_field('resource_image'); ?>" alt="<?php the_title(); ?>"></a>
				</div>
	...
	<div class="row show-for-medium">
		<div class="text-center">
			<a href="<?php echo $ssLink; ?>" title="Download White Paper" target="_blank"><button style="margin: 1rem 0rem 3rem; width: auto;"><i class="fa fa-download" aria-hidden="true"></i> Download</button></a>
		</div>
	</div>
	<!-- /Button -->
