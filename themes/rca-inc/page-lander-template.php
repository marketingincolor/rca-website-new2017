...
<?php if ( $sub_container_one != '' ) : ?>
	<!-- Subcontent One -->
	<div id="sub-container-one" class="<?php echo ($sub_container_one_style == 'none') ? 'default' : 'row'; ?>">
		<div class="<?php echo ($sub_container_one_style == 'none') ? 'stripped' : 'small-12 columns'; ?>">
...
<?php if ( $sub_container_two != '' ) : ?>
	<!-- Subcontent Two -->
	<div id="sub-container-two" class="<?php echo ($sub_container_two_style == 'none') ? 'default' : 'row'; ?>">
		<div class="<?php echo ($sub_container_two_style == 'none') ? 'stripped' : 'small-12 columns'; ?>">
...
<?php if ( $sub_container_three != '' ) : ?>
	<!-- Subcontent Three -->
	<div id="sub-container-three" class="<?php echo ($sub_container_three_style == 'none') ? 'default' : 'row'; ?>">
		<div class="<?php echo ($sub_container_three_style == 'none') ? 'stripped' : 'small-12 columns'; ?>">
