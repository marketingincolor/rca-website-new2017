	  ...
	  // out properly
		...
		$blueForm.find('#form-submit').on('click',function(e){
          ...
          $('#industry-hidden').val(arr.join(','));
              ...
              __ss_noform.push(['submit', function () {window.location = 'http://rcainc.com/success';}, '2c8b9505-3172-42ce-9d67-efa05d3bc26e']);
...
<script type="text/javascript">
    ...
    __ss_noform.push(['submit', , '2c8b9505-3172-42ce-9d67-efa05d3bc26e']);
</script>
